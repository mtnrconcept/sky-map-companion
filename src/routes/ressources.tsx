...
export const Route = createFileRoute("/ressources")({
  head: () => ({
    meta: [
      { title: "Ressources astro — tutoriels complets, logiciels et matériel" },
      {
        name: "description",
        content:
          "Tutoriels d'astrophotographie pas à pas du smartphone au ciel profond, réglages détaillés, logiciels de traitement, catalogue de matériel (télescopes, montures, oculaires, caméras) et sélection de blogs et vidéos.",
      },
      {
        property: "og:title",
        content: "Ressources astro — tutoriels détaillés et matériel",
      },
      {
        property: "og:description",
        content:
          "Guides pas à pas d'astrophoto, réglages types, logiciels, matériel conseillé par budget, blogs et chaînes YouTube.",
      },
  ...
  return (
    <main className="min-h-[100dvh] bg-background pb-20">
      <PageHeader
        ...
        subtitle="Guides d'astrophotographie pas à pas, logiciels, catalogue de matériel, sites de planification, blogs et chaînes vidéo — du premier cliché lunaire au ciel profond en bande étroite."
      />

      <div className="mx-auto max-w-6xl space-y-14 px-4 pt-8">
        <section>
          <h2 className="flex items-center gap-2 text-lg font-semibold">
            <Camera className="size-4 text-primary" /> Tutoriels détaillés
          </h2>
          <p className="mt-1 text-sm text-muted-foreground">
            {TUTORIALS.length} guides complets, chacun avec le matériel requis, les
            étapes dans l'ordre, les réglages exacts et les erreurs à éviter.
          </p>
          <div className="mt-4 space-y-4">
            {TUTORIALS.map((t) => (
              ...
              >
                ...
                <p className="mt-4 rounded-md bg-secondary/60 px-2.5 py-1.5 font-mono text-xs text-foreground/80">
                  {t.settings}
                </p>
                <div className="mt-3">
                  <p className="label-caps flex items-center gap-1.5 text-muted-foreground">
                    <AlertTriangle className="size-3.5" /> Erreurs fréquentes
                  </p>
        ...
        <section>
          <h2 className="flex items-center gap-2 text-lg font-semibold">
            <ShoppingCart className="size-4 text-primary" /> Matériel : catalogue
            complet
          </h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Sélection par usage avec ordres de prix réels. Les liens ouvrent les
            rayons correspondants chez Astroshop.
          </p>
        ...
        <LinkSection
          ...
          title="Logiciels de capture et de traitement"
          items={SOFTWARE}
        />
        <LinkSection
          icon={<Globe className="size-4 text-primary" />}
          title="Planification, météo et éphémérides"
          items={PLANNING}
        />
        <LinkSection
          icon={<BookOpen className="size-4 text-primary" />}
          title="Blogs, forums et sites de référence"
          items={BLOGS}
        />
        <LinkSection
