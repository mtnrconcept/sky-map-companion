...
// POST /api/cosmos/report â€” soumet une observation en temps rÃ©el
export const ServerRoute = createServerFileRoute("/api/cosmos/report").methods({
  POST: async ({ request }) => {
 ...
 // DÃ©clenche l'analyse de cluster en arriÃ¨re-plan (sans await)
