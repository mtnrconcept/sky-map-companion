 ...
 * Qualifie une frame uploadÃ©e : analyse IA, score qualitÃ©, groupe instrument.
 * AppelÃ© automatiquement aprÃ¨s chaque upload.
 */
export const ServerRoute = createServerFileRoute("/api/astrostack/qualify").methods({
 ...
 // Met Ã  jour l'upload avec les rÃ©sultats
 await supabase
 .from("astro_uploads")
 .update({
