...
export const TUTORIALS: Tutorial[] = [
  {
    ...
    settings:
      "ISO 50-100 · 1/125 à 1/250 s · -2 EV · mise au point infini verrouillée · RAW si disponible",
    pitfalls: [
  ...
  },
  {
    ...
    settings:
      "f/2.8 · ISO 1600-3200 · 15 à 25 s · RAW · balance des blancs 4000 K · stabilisation OFF",
    pitfalls: [
  ...
  },
  {
    ...
    settings:
      "Darks + flats + offsets obligatoires · rejet Winsorized Sigma Clipping · empilement en 32 bits",
    pitfalls: [
  ...
  },
  {
    ...
    settings:
      "Erreur de mise en station < 5' pour 2 min de pose à 500 mm · autoguidage visé RMS < 1\"",
    pitfalls: [
  ...
  },
  {
    ...
    settings:
      "Poses 180-300 s · gain unitaire · -10 °C · 4 h minimum par couche · dithering activé",
    pitfalls: [
  ...
  },
  {
    ...
    settings:
      "Vision décalée · lampe rouge < 5 lux · adaptation 20-30 min · thermos et siège assis",
    pitfalls: [
  ...
  },
  {
    ...
    settings:
      "Grossissement utile max ≈ 2 × diamètre en mm · oculaire principal ≈ focale/50 pour le ciel profond",
    pitfalls: [
...
export const GEAR: GearCategory[] = [
  {
    ...
    items: [
      {
        name: "Télescopes (toutes catégories)",
        desc: "Le rayon complet : Newton, Dobson, lunettes, Maksutov, Schmidt-Cassegrain.",
        price: "dès 100 €",
        url: `${SHOP}/telescopes/c/1`,
      },
      {
        name: "Dobson 150-250 mm",
        desc: "Le meilleur rapport diamètre/prix pour le visuel ciel profond.",
        price: "250-800 €",
        url: search("dobson"),
      },
      {
        name: "Newton sur équatoriale",
        desc: "Polyvalent visuel et photo, à condition d'une monture suffisante.",
        price: "400-1200 €",
        url: search("newton equatorial"),
      },
      {
        name: "Lunette apochromatique ED",
        desc: "Piqué et couleurs parfaites, la référence pour l'astrophoto grand champ.",
        price: "500-3000 €",
        url: search("lunette apochromatique"),
      },
      {
        name: "Maksutov 90-150 mm",
        desc: "Compact et longue focale : Lune, planètes, étoiles doubles.",
        price: "250-900 €",
        url: search("maksutov"),
      },
      {
        name: "Télescopes intelligents",
        desc: "Instruments automatisés type Seestar / eVscope, prêts en 2 minutes.",
        price: "500-4000 €",
        url: search("telescope intelligent"),
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Montures (catalogue)",
        desc: "Azimutales, équatoriales, GoTo, harmoniques.",
        price: "dès 150 €",
        url: `${SHOP}/montures/c/3`,
      },
      {
        name: "Monture équatoriale GoTo",
        desc: "Suivi motorisé et pointage automatique de milliers d'objets.",
        price: "400-2500 €",
        url: search("monture goto equatoriale"),
      },
      {
        name: "Star Adventurer / monture de voyage",
        desc: "Suivi léger pour appareil photo et petite lunette.",
        price: "300-600 €",
        url: search("star adventurer"),
      },
      {
        name: "Montures harmoniques",
        desc: "Très forte charge pour un poids minime, sans contrepoids.",
        price: "1000-3000 €",
        url: search("monture harmonique"),
      },
      {
        name: "Trépieds et colonnes",
        desc: "Base stable : le maillon faible le plus souvent négligé.",
        price: "100-800 €",
        url: search("trepied colonne"),
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Oculaires (catalogue)",
        desc: "Plössl, grand champ 68-82°, ultra grand champ 100°.",
        price: "dès 30 €",
        url: `${SHOP}/oculaires/c/2`,
      },
      {
        name: "Oculaires grand champ 68-82°",
        desc: "Confort d'observation et immersion sur les grands objets.",
        price: "80-400 €",
        url: search("oculaire grand champ"),
      },
      {
        name: "Lentilles de Barlow",
        desc: "Doublent ou triplent le grossissement : indispensables en planétaire.",
        price: "40-250 €",
        url: search("barlow"),
      },
      {
        name: "Zoom oculaires",
        desc: "8-24 mm : un seul accessoire pour balayer la plage de grossissements.",
        price: "100-350 €",
        url: search("oculaire zoom"),
      },
      {
        name: "Renvois coudés",
        desc: "Confort de visée sur lunettes et Cassegrain, diélectriques de préférence.",
        price: "40-300 €",
        url: search("renvoi coude"),
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Caméras astronomiques",
        desc: "Le catalogue complet : planétaire, ciel profond, guidage.",
        price: "dès 150 €",
        url: `${SHOP}/cameras-astronomiques/c/18`,
      },
      {
        name: "Caméras planétaires",
        desc: "Haute cadence pour le lucky imaging (ASI664, QHY5III).",
        price: "200-600 €",
        url: search("camera planetaire"),
      },
      {
        name: "Caméras refroidies ciel profond",
        desc: "Capteurs APS-C/4/3 refroidis, bruit thermique quasi nul.",
        price: "700-3500 €",
        url: search("camera refroidie"),
      },
      {
        name: "Autoguidage (lunette + caméra)",
        desc: "Corrige les erreurs de suivi, autorise les poses de 5 à 10 minutes.",
        price: "200-500 €",
        url: search("autoguidage lunette guide"),
      },
      {
        name: "Correcteurs et réducteurs de champ",
        desc: "Étoiles rondes jusque dans les coins du capteur.",
        price: "150-700 €",
        url: search("correcteur de coma reducteur"),
      },
      {
        name: "Adaptateurs et bagues T2",
        desc: "Relier boîtier photo, filtres et tirage optique correct.",
        price: "15-120 €",
        url: search("bague T2 adaptateur"),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "UHC, OIII, bande étroite, solaires, planétaires.",
        price: "dès 25 €",
        url: `${SHOP}/filtres/c/13`,
      },
      {
        name: "Filtres UHC / anti-pollution",
        desc: "Contraste immédiat sur les nébuleuses en visuel urbain.",
        price: "60-250 €",
        url: search("filtre UHC"),
      },
      {
        name: "Filtres dual-band Hα/OIII",
        desc: "Astrophoto couleur sous ciel pollué, le plus rentable des filtres photo.",
        price: "200-500 €",
        url: search("filtre dual band"),
      },
      {
        name: "Filtres solaires et Hα",
        desc: "Feuille AstroSolar ou lunette Hα dédiée. Sécurité absolue exigée.",
        price: "30-2000 €",
        url: search("filtre solaire"),
      },
      {
        name: "Filtres planétaires colorés",
        desc: "Renforcent les calottes martiennes ou les bandes de Jupiter.",
        price: "20-80 €",
        url: search("filtre planetaire"),
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Jumelles (catalogue)",
        desc: "Toutes les jumelles d'observation astronomique.",
        price: "dès 60 €",
        url: `${SHOP}/jumelles/c/6`,
      },
      {
        name: "Jumelles 10×50",
        desc: "Le standard universel : Pléiades, Andromède, amas d'Hercule.",
        price: "80-300 €",
        url: search("jumelles 10x50"),
      },
      {
        name: "Jumelles géantes 15×70 / 20×80",
        desc: "Beaucoup plus de lumière, mais trépied obligatoire.",
        price: "150-500 €",
        url: search("jumelles 20x80"),
      },
      {
        name: "Adaptateurs jumelles-trépied",
        desc: "Indispensable au-delà de 10× pour stabiliser l'image.",
        price: "15-60 €",
        url: search("adaptateur jumelles trepied"),
      },
    ],
  },
  {
    ...
    blurb:
      "Le confort et la lutte contre la buée décident souvent de la durée réelle d'une séance.",
    items: [
      {
        name: "Résistances chauffantes anti-buée",
        desc: "Empêchent la condensation sur l'optique et le chercheur.",
        price: "25-120 €",
        url: search("resistance chauffante anti buee"),
      },
      {
        name: "Lampes rouges frontales",
        desc: "Préservent la vision nocturne, à intensité réglable.",
        price: "10-60 €",
        url: search("lampe rouge astronomie"),
      },
      {
        name: "Alimentations et batteries",
        desc: "Powerbank 12 V pour monture, caméra et dew heater.",
        price: "60-400 €",
        url: search("alimentation 12V astronomie"),
      },
      {
        name: "Masques de Bahtinov",
        desc: "Mise au point parfaite en 30 secondes grâce aux aigrettes.",
        price: "15-70 €",
        url: search("masque bahtinov"),
      },
      {
        name: "Chercheurs et point rouge",
        desc: "Pointer vite et sans se tordre le cou.",
        price: "30-200 €",
        url: search("chercheur point rouge"),
      },
      {
        name: "Valises et sacs de transport",
        desc: "Protéger optiques et oculaires en déplacement.",
        price: "40-300 €",
        url: search("valise transport telescope"),
      },
    ],
  },
  {
    ...
    blurb:
      "Un atlas papier reste plus rapide qu'un écran sur le terrain, et n'a pas besoin de batterie.",
    items: [
      {
        name: "Atlas et cartes du ciel",
        desc: "Pocket Sky Atlas, Interstellarum Deep Sky Atlas.",
        price: "20-90 €",
        url: search("atlas du ciel"),
      },
      {
        name: "Livres d'astronomie",
        desc: "Guides d'observation, astrophoto, astrophysique.",
        price: "15-80 €",
        url: search("livre astronomie"),
      },
      {
        name: "Planisphères",
        desc: "Carte tournante réglée sur la date et l'heure.",
        price: "10-30 €",
        url: search("planisphere"),
      },
    ],
  },
];
...
export const SOFTWARE = [
  {
    name: "Siril",
    desc: "Prétraitement et traitement complet, gratuit et open source. Le cœur d'une chaîne moderne.",
    url: "https://siril.org/",
  },
  {
    name: "DeepSkyStacker",
    desc: "Empilement classique pour le ciel profond sous Windows, très simple.",
    url: "http://deepskystacker.free.fr/french/index.html",
  },
  {
    name: "AutoStakkert!",
    desc: "Référence du stacking planétaire à partir de vidéos SER/AVI.",
    url: "https://www.autostakkert.com/",
  },
  {
    name: "RegiStax",
    desc: "Ondelettes : l'outil historique pour révéler les détails planétaires.",
    url: "https://www.astronomie.be/registax/",
  },
  {
    name: "GraXpert",
    desc: "Suppression automatique par IA des gradients de pollution lumineuse.",
    url: "https://www.graxpert.com/",
  },
  {
    name: "StarNet++",
    desc: "Sépare les étoiles de la nébuleuse pour les traiter indépendamment.",
    url: "https://www.starnetastro.com/",
  },
  {
    name: "PHD2 Guiding",
    desc: "Autoguidage gratuit, standard de fait sur toutes les montures.",
    url: "https://openphdguiding.org/",
  },
  {
    name: "N.I.N.A.",
    desc: "Séquenceur complet pour automatiser une nuit entière d'acquisition.",
    url: "https://nighttime-imaging.eu/",
  },
  {
    name: "ASTAP",
    desc: "Astrométrie (plate solving) rapide et empilement, gratuit.",
    url: "https://www.hnsky.org/astap.htm",
  },
  {
    name: "WinJUPOS",
    desc: "Dérotation planétaire et mesures sur Jupiter, Mars et Saturne.",
    url: "http://jupos.privat.t-online.de/",
  },
  {
    name: "Stellarium",
    desc: "Planétarium bureau et web pour préparer chaque séance.",
    url: "https://stellarium.org/fr/",
  },
  {
    name: "StarStaX",
    desc: "Fusion de filés d'étoiles avec comblement des interruptions.",
    url: "https://markus-enzweiler.de/software/starstax/",
  },
  {
    name: "Sequator",
    desc: "Empilement paysage nocturne très simple, ciel et sol séparés.",
    url: "https://sites.google.com/site/sequatorglobal/",
  },
  {
    name: "PixInsight",
    desc: "La suite professionnelle payante, courbe d'apprentissage raide mais sans équivalent.",
...
export const PLANNING = [
  {
    ...
    desc: "Classe de Bortle et sites sombres autour de chez vous.",
    url: "https://www.lightpollutionmap.info/",
  },
  {
    name: "Clear Outside",
    desc: "Météo astro : nuages par couche, seeing, transparence, humidité.",
    url: "https://clearoutside.com/",
  },
  {
    name: "Meteoblue Astronomy",
    desc: "Seeing et jet stream sur 3 jours, très fiable en Europe.",
    url: "https://www.meteoblue.com/fr/meteo/outdoorsports/seeing",
  },
  {
    name: "Heavens-Above",
    desc: "Passages ISS, satellites Starlink, éphémérides planétaires.",
    url: "https://heavens-above.com/",
  },
  {
    name: "IMO — pluies de météores",
    desc: "Calendrier officiel annuel des essaims et de leur ZHR.",
    url: "https://www.imo.net/resources/calendar/",
  },
  {
    name: "Telescopius",
    desc: "Planificateur de cibles, cadrage du capteur, listes d'objets.",
    url: "https://telescopius.com/",
  },
  {
    name: "IMCCE — éphémérides",
    desc: "Éphémérides officielles françaises : éclipses, occultations, phénomènes.",
    url: "https://www.imcce.fr/",
  },
  {
    name: "Astrometry.net",
    desc: "Résolution astrométrique en ligne de n'importe quelle photo du ciel.",
...
export const BLOGS = [
  {
    name: "Astrosurf",
    desc: "La communauté francophone historique : forums, tutoriels, tests matériel.",
    url: "https://www.astrosurf.com/",
  },
  {
    name: "Webastro",
    desc: "Forum francophone très actif, section débutants exemplaire et petites annonces.",
    url: "https://www.webastro.net/",
  },
  {
    name: "Ciel & Espace",
    desc: "Actualité astronomique et éphémérides en français.",
    url: "https://www.cieletespace.fr/",
  },
  {
    name: "Sky & Telescope",
    desc: "Guides d'observation hebdomadaires et cartes du ciel.",
    url: "https://skyandtelescope.org/",
  },
  {
    name: "Astrobin",
    desc: "Galerie d'astrophotos avec tous les réglages et le matériel de chaque image.",
    url: "https://www.astrobin.com/",
  },
  {
    name: "Cloudy Nights",
    desc: "Le plus grand forum anglophone : tests, conseils, occasions.",
    url: "https://www.cloudynights.com/",
  },
  {
    name: "AFA — Association française d'astronomie",
    desc: "Nuits des étoiles, revue Ciel & Espace, clubs partout en France.",
    url: "https://www.afastronomie.fr/",
  },
  {
    name: "APOD (NASA)",
    desc: "Une image astronomique commentée chaque jour depuis 1995.",
    url: "https://apod.nasa.gov/apod/astropix.html",
  },
  {
    name: "ESA/Hubble",
    desc: "Images en pleine résolution et explications scientifiques libres de droits.",
    url: "https://esahubble.org/images/",
  },
  {
    name: "Astronomes.com",
    desc: "Ressources et guides francophones pour débuter.",
    url: "https://www.astronomes.com/",
  },
];
...
export const VIDEOS = [
  {
    name: "AstroBackyard",
    desc: "Astrophoto du ciel profond, matériel et traitement pas à pas.",
    url: "https://www.youtube.com/@AstroBackyard",
  },
  {
    name: "Cuiv, The Lazy Geek",
    desc: "Tests de matériel et automatisation de l'astrophoto.",
    url: "https://www.youtube.com/@CuivTheLazyGeek",
  },
  {
    name: "Nebula Photos",
    desc: "Astrophoto accessible, en ville et à petit budget.",
    url: "https://www.youtube.com/@NebulaPhotos",
  },
  {
    name: "Deep Sky Detail",
    desc: "Traitement avancé sous PixInsight expliqué clairement.",
    url: "https://www.youtube.com/@DeepSkyDetail",
  },
  {
    name: "Astro Guigeek",
    desc: "Chaîne francophone : tutoriels, tests et sorties terrain.",
    url: "https://www.youtube.com/@AstroGuigeek",
  },
  {
    name: "Le Sptinik",
    desc: "Vulgarisation astronomique en français.",
    url: "https://www.youtube.com/@LeSptinik",
  },
  {
    name: "La Chaîne Astro",
    desc: "Actualité et observation commentées en français.",
    url: "https://www.youtube.com/@LaChaineAstro",
  },
  {
    name: "Astro Photons",
    desc: "Astrophotographie francophone, du matériel au traitement Siril.",
    url: "https://www.youtube.com/@AstroPhotons",
  },
  {
    name: "Peter Zelinka",
    desc: "Paysage nocturne et Voie lactée, très pédagogique.",
    url: "https://www.youtube.com/@PeterZelinka",
  },
  {
    name: "Late Night Astronomy",
    desc: "Sessions d'observation et conseils d'achat sans langue de bois.",
    url: "https://www.youtube.com/@LateNightAstronomy",
  },
];
